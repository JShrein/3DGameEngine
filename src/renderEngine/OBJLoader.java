...
public class OBJLoader {
	public static RawModel loadObjModel(String filename, Loader loader)
	{
		...
		try {
			fileReader = new FileReader(new File("resources/" + filename + ".obj"));
		...
		{
			e.printStackTrace();
			System.out.println("ERROR: obj data read failed");
		}
									  ...
									  float[] 			normalsArray)
	{
		...
		Vector2f currentTexCoord = texCoords.get(Integer.parseInt(vertexData[1]) - 1);
